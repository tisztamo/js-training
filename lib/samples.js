...
ES6.Ambulance = function (_ES6$Car) {
  ...
  function Ambulance() {
    ...
    var _this = _possibleConstructorReturn(this, (Ambulance.__proto__ || Object.getPrototypeOf(Ambulance)).call(this, "Ambulance Car", 100, 60, 70, 12));
  ...
  _createClass(Ambulance, [{
    key: "getMaxRange",
    value: function getMaxRange() {
      return _get(Ambulance.prototype.__proto__ || Object.getPrototypeOf(Ambulance.prototype), "getMaxRange", this).call(this) * this.rangeFactor;
    }
  }], [{
    key: "staticFn",
...
var ECar = function (_Car) {
  ...
  function ECar() {
    ...
    return _possibleConstructorReturn(this, (ECar.__proto__ || Object.getPrototypeOf(ECar)).call(this, "ECar"));
  }
